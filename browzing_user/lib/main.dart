import 'package:browzing/browzing.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'browzing user'),
      routes: {
        Browzing.routeName: (ctx) => Browzing(),
      },
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _secondPage(BuildContext context, Widget page) async {
    ...
    //print("I got back the data $dataFromSecondPage");
    setState(() {
      returnData = dataFromSecondPage;
    });
  }
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text("You earned ${returnData} credits",
